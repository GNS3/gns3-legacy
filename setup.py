...
#                  ('vboxwrapper/tcp_pipe_proxy.py'),
    ...
    os.system('cp ../dynamips-0.2.10-dev-OSX.intel64.bin ./GNS3.app/Contents/Resources')
    ...
    os.chmod('./GNS3.app/Contents/Resources/dynamips-0.2.10-dev-OSX.intel64.bin', 0755)
