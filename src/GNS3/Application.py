...
class Application(QApplication, Singleton):
    ...
    def run(self, file):
        ...
        confo.default_junos_options = str(ConfDB().get('Qemu/default_junos_options', unicode('-nographic')))
        ...
        confo.default_asa_options = str(ConfDB().get('Qemu/default_asa_options', unicode('-hdachs 980,16,32 -nographic')))
