...
class Application(QApplication, Singleton):
    ...
    def run(self, file):
        ...
        confo.auto_close_node_panel = ConfDB().value("GNS3/gui_auto_close_node_panel", QVariant(False)).toBool()
...
#                        self.showTipsDialog()
    ...
    def syncConf(self):
        ...
        c.set('GNS3/gui_auto_close_node_panel', confo.auto_close_node_panel)
