...
class Ui_SymbolManager(object):
    def setupUi(self, SymbolManager):
        ...
        SymbolManager.resize(QtCore.QSize(QtCore.QRect(0,0,703,575).size()).expandedTo(SymbolManager.minimumSizeHint()))
        SymbolManager.setWindowIcon(QtGui.QIcon(":/images/logo_icon.png"))
