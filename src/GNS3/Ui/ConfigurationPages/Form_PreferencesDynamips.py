...
#
# Created: Sat Apr 12 17:18:05 2008
...
class Ui_PreferencesDynamips(object):
    def setupUi(self, PreferencesDynamips):
        ...
        PreferencesDynamips.resize(QtCore.QSize(QtCore.QRect(0,0,430,439).size()).expandedTo(PreferencesDynamips.minimumSizeHint()))
        ...
        self.gridlayout.addWidget(self.checkBoxClearWorkdir,4,0,1,4)
        ...
        self.gridlayout.addWidget(self.checkBoxSparseMem,9,0,1,2)
