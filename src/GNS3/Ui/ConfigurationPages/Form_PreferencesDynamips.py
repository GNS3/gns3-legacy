...
class Ui_PreferencesDynamips(object):
    def setupUi(self, PreferencesDynamips):
        ...
        PreferencesDynamips.resize(QtCore.QSize(QtCore.QRect(0,0,430,395).size()).expandedTo(PreferencesDynamips.minimumSizeHint()))
        ...
        self.checkBoxClearOldFiles = QtGui.QCheckBox(self.groupBox_2)
        self.checkBoxClearOldFiles.setObjectName("checkBoxClearOldFiles")
        self.gridlayout2.addWidget(self.checkBoxClearOldFiles,5,0,1,1)
    ...
    def retranslateUi(self, PreferencesDynamips):
        ...
        self.checkBoxClearOldFiles.setText(QtGui.QApplication.translate("PreferencesDynamips", "Clear old files generated by Dynamips", None, QtGui.QApplication.UnicodeUTF8))
