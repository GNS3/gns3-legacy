...
class Ui_PreferencesQemu(object):
    def setupUi(self, PreferencesQemu):
        ...
        PreferencesQemu.resize(476, 448)
        ...
        self.gridLayout_7.addWidget(self.lineEditQemuwrapperPath, 1, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.QemuwrapperPath_browser, 1, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.lineEditQemuwrapperWorkdir, 3, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.QemuwrapperWorkdir_browser, 3, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.comboBoxBinding, 5, 0, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.checkBoxEnableQemuManager, 6, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.checkBoxQemuManagerImport, 7, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.lineEditHostExternalQemu, 8, 1, 1, 2)
        self.label_31 = QtGui.QLabel(self.groupBox_2)
        self.label_31.setObjectName("label_31")
        self.gridLayout_7.addWidget(self.label_31, 9, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.baseUDP, 9, 1, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.baseConsole, 10, 1, 1, 2)
        ...
        self.PIXcheckBoxQemuDefaults = QtGui.QCheckBox(self.groupBox_6)
        self.PIXcheckBoxQemuDefaults.setChecked(True)
        self.PIXcheckBoxQemuDefaults.setObjectName("PIXcheckBoxQemuDefaults")
        self.gridLayout_6.addWidget(self.PIXcheckBoxQemuDefaults, 0, 0, 1, 2)
        ...
        self.PIXImage.setEnabled(False)
        ...
        self.PIXImage_Browser.setEnabled(False)
        ...
        self.PIXMemory.setEnabled(False)
        ...
        self.PIXNIC.addItem("")
        self.PIXNIC.addItem("")
        self.gridLayout_6.addWidget(self.PIXNIC, 3, 1, 1, 2)
        self.PIXcheckBoxKqemu = QtGui.QCheckBox(self.groupBox_6)
        self.PIXcheckBoxKqemu.setEnabled(False)
        self.PIXcheckBoxKqemu.setObjectName("PIXcheckBoxKqemu")
        self.gridLayout_6.addWidget(self.PIXcheckBoxKqemu, 4, 0, 1, 2)
        ...
        self.JunOScheckBoxQemuDefaults = QtGui.QCheckBox(self.groupBox_5)
        self.JunOScheckBoxQemuDefaults.setChecked(True)
        self.JunOScheckBoxQemuDefaults.setObjectName("JunOScheckBoxQemuDefaults")
        self.gridLayout_2.addWidget(self.JunOScheckBoxQemuDefaults, 0, 0, 1, 2)
        self.JunOSImage = QtGui.QLineEdit(self.groupBox_5)
        self.JunOSImage.setEnabled(False)
        ...
        self.JunOSImage_Browser.setEnabled(False)
        ...
        self.JunOSNIC.setEnabled(False)
        ...
        self.JunOSNIC.addItem("")
        self.JunOSNIC.addItem("")
        self.gridLayout_2.addWidget(self.JunOSNIC, 3, 1, 1, 2)
        self.JunOScheckBoxKqemu = QtGui.QCheckBox(self.groupBox_5)
        self.JunOScheckBoxKqemu.setEnabled(False)
        ...
        self.JunOScheckBoxKVM.setEnabled(False)
        ...
        self.ASAcheckBoxQemuDefaults = QtGui.QCheckBox(self.groupBox_3)
        self.ASAcheckBoxQemuDefaults.setChecked(True)
        self.ASAcheckBoxQemuDefaults.setObjectName("ASAcheckBoxQemuDefaults")
        self.gridLayout_3.addWidget(self.ASAcheckBoxQemuDefaults, 0, 0, 1, 2)
        self.label_14 = QtGui.QLabel(self.groupBox_3)
        self.label_14.setObjectName("label_14")
        self.gridLayout_3.addWidget(self.label_14, 1, 0, 1, 1)
        self.ASAImage = QtGui.QLineEdit(self.groupBox_3)
        self.ASAImage.setEnabled(False)
        self.ASAImage.setObjectName("ASAImage")
        self.gridLayout_3.addWidget(self.ASAImage, 1, 1, 1, 1)
        self.ASAImage_Browser = QtGui.QToolButton(self.groupBox_3)
        self.ASAImage_Browser.setEnabled(False)
        self.ASAImage_Browser.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        self.ASAImage_Browser.setObjectName("ASAImage_Browser")
        self.gridLayout_3.addWidget(self.ASAImage_Browser, 1, 2, 1, 1)
        ...
        self.ASANIC.addItem("")
        self.ASANIC.addItem("")
        self.gridLayout_3.addWidget(self.ASANIC, 3, 1, 1, 2)
        self.ASAcheckBoxKqemu = QtGui.QCheckBox(self.groupBox_3)
        self.ASAcheckBoxKqemu.setEnabled(False)
        self.ASAcheckBoxKqemu.setObjectName("ASAcheckBoxKqemu")
        self.gridLayout_3.addWidget(self.ASAcheckBoxKqemu, 4, 0, 1, 2)
        self.ASAcheckBoxKVM = QtGui.QCheckBox(self.groupBox_3)
        self.ASAcheckBoxKVM.setEnabled(False)
    ...
    def retranslateUi(self, PreferencesQemu):
        ...
        self.PIXcheckBoxQemuDefaults.setText(QtGui.QApplication.translate("PreferencesQemu", "Use Qemu settings", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.JunOScheckBoxQemuDefaults.setText(QtGui.QApplication.translate("PreferencesQemu", "Use Qemu settings", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.ASAcheckBoxQemuDefaults.setText(QtGui.QApplication.translate("PreferencesQemu", "Use Qemu settings", None, QtGui.QApplication.UnicodeUTF8))
        self.label_14.setText(QtGui.QApplication.translate("PreferencesQemu", "Binary image:", None, QtGui.QApplication.UnicodeUTF8))
        self.ASAImage_Browser.setText(QtGui.QApplication.translate("PreferencesQemu", "...", None, QtGui.QApplication.UnicodeUTF8))
