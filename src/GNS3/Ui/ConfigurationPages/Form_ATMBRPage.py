...
class Ui_ATMBRPage(object):
    def setupUi(self, ATMBRPage):
        ...
        ATMBRPage.resize(QtCore.QSize(QtCore.QRect(0,0,403,383).size()).expandedTo(ATMBRPage.minimumSizeHint()))
        ...
        self.spinBoxDestVCI.setProperty("value",QtCore.QVariant(1))
