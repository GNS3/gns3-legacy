...
#
# Created: Wed Oct  5 20:06:40 2011
...
class Ui_PreferencesCapture(object):
    def setupUi(self, PreferencesCapture):
        ...
        PreferencesCapture.resize(566, 308)
    ...
    def retranslateUi(self, PreferencesCapture):
        ...
        self.label_4.setText(QtGui.QApplication.translate("PreferencesCapture", "Hint: To actually start capturing traffic, right click on link\'s small colored circle.", None, QtGui.QApplication.UnicodeUTF8))
