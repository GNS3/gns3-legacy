...
"}"))
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/zoom-in.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/zoom-in-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/zoom-out.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/zoom-out-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/applications.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/edit-undo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Undo.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/edit-redo.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Redo.setIcon(icon17)
        self.action_Redo.setObjectName(_fromUtf8("action_Redo"))
        self.action_SuspendAll = QtGui.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/pause2-test.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/pause3-test.svg")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/pause3-test.svg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.action_SuspendAll.setIcon(icon18)
        self.action_SuspendAll.setObjectName(_fromUtf8("action_SuspendAll"))
        self.action_Clear = QtGui.QAction(MainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/new.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Clear.setIcon(icon19)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/add-note.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_AddNote.setIcon(icon20)
        self.action_AddNote.setObjectName(_fromUtf8("action_AddNote"))
        self.action_New = QtGui.QAction(MainWindow)
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/new-project.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_New.setIcon(icon21)
        self.action_New.setObjectName(_fromUtf8("action_New"))
        self.action_config = QtGui.QAction(MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/import_export_configs.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_config.setIcon(icon22)
        self.action_config.setObjectName(_fromUtf8("action_config"))
        self.action_InsertImage = QtGui.QAction(MainWindow)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/image.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_InsertImage.setIcon(icon23)
        self.action_InsertImage.setObjectName(_fromUtf8("action_InsertImage"))
        self.action_Symbol_Manager = QtGui.QAction(MainWindow)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/node_conception.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Symbol_Manager.setIcon(icon24)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/rectangle3-test.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon25.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/rectangle2-test.svg")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon25.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/rectangle2-test.svg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.action_DrawRectangle.setIcon(icon25)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/ellipse3-test.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/ellipse2-test.svg")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon26.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/ellipse2-test.svg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.action_DrawEllipse.setIcon(icon26)
        ...
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/show-interface-names.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ShowinterfaceNames.setIcon(icon27)
        ...
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/snapshot.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Snapshot.setIcon(icon28)
        ...
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/save-as-project.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_SaveProjectAs.setIcon(icon29)
        self.action_SaveProjectAs.setObjectName(_fromUtf8("action_SaveProjectAs"))
        self.action_ReloadAll = QtGui.QAction(MainWindow)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/reload.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ReloadAll.setIcon(icon30)
        ...
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/aux-console.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ConsoleAuxAll.setIcon(icon31)
        ...
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/virtualbox.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ShowVirtualBoxManager.setIcon(icon32)
        ...
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/router.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon33.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/router-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.action_Router.setIcon(icon33)
        self.action_Router.setObjectName(_fromUtf8("action_Router"))
        self.action_Switch = QtGui.QAction(MainWindow)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/switch.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon34.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/switch-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.action_Switch.setIcon(icon34)
        self.action_Switch.setObjectName(_fromUtf8("action_Switch"))
        self.action_EndDevices = QtGui.QAction(MainWindow)
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/PC.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon35.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/PC-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.action_EndDevices.setIcon(icon35)
        self.action_EndDevices.setObjectName(_fromUtf8("action_EndDevices"))
        self.action_OtherDevices = QtGui.QAction(MainWindow)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/other-devices.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon36.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/other-devices-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.action_OtherDevices.setIcon(icon36)
        self.action_OtherDevices.setObjectName(_fromUtf8("action_OtherDevices"))
        self.action_Firewall = QtGui.QAction(MainWindow)
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/firewall.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon37.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/firewall-hover.png")), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.action_Firewall.setIcon(icon37)
        self.action_Firewall.setObjectName(_fromUtf8("action_Firewall"))
        self.action_IDS = QtGui.QAction(MainWindow)
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/ids.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.toolBar_Devices.addSeparator()
        self.toolBar_Devices.addAction(self.action_Firewall)
        self.toolBar_Devices.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.graphicsView.setStatusTip(QtGui.QApplication.translate("MainWindow", "Topology Graphic View", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.treeWidget_TopologySummary.setStatusTip(QtGui.QApplication.translate("MainWindow", "Topology Summary", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.textEditConsole.setStatusTip(QtGui.QApplication.translate("MainWindow", "Console", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.UndoViewDock.setStatusTip(QtGui.QApplication.translate("MainWindow", "Undo Stack", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.capturesDock.setStatusTip(QtGui.QApplication.translate("MainWindow", "Captures", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_ShowinterfaceNames.setStatusTip(QtGui.QApplication.translate("MainWindow", "Show interface labels", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_Switch.setText(QtGui.QApplication.translate("MainWindow", "Switch", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Switch.setToolTip(QtGui.QApplication.translate("MainWindow", "Switch", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.action_OtherDevices.setText(QtGui.QApplication.translate("MainWindow", "Other devices", None, QtGui.QApplication.UnicodeUTF8))
        self.action_OtherDevices.setToolTip(QtGui.QApplication.translate("MainWindow", "Other devices", None, QtGui.QApplication.UnicodeUTF8))
        self.action_OtherDevices.setStatusTip(QtGui.QApplication.translate("MainWindow", "Select Other devices", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Firewall.setText(QtGui.QApplication.translate("MainWindow", "Firewall", None, QtGui.QApplication.UnicodeUTF8))
        self.action_Firewall.setToolTip(QtGui.QApplication.translate("MainWindow", "Firewall", None, QtGui.QApplication.UnicodeUTF8))
