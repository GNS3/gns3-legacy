...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icons/pause.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_SuspendAll.setIcon(icon15)
        self.action_SuspendAll.setObjectName("action_SuspendAll")
        self.action_Clear = QtGui.QAction(MainWindow)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icons/edit-clear.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Clear.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icons/add-note.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_AddNote.setIcon(icon17)
        self.action_AddNote.setObjectName("action_AddNote")
        self.action_New = QtGui.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icons/new.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_New.setIcon(icon18)
        self.action_New.setObjectName("action_New")
        self.action_config = QtGui.QAction(MainWindow)
        self.action_config.setIcon(icon14)
        self.action_config.setObjectName("action_config")
        self.action_InsertImage = QtGui.QAction(MainWindow)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icons/image.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_InsertImage.setIcon(icon19)
        self.action_InsertImage.setObjectName("action_InsertImage")
        self.action_Symbol_Manager = QtGui.QAction(MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icons/node_conception.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Symbol_Manager.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icons/rectangle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_DrawRectangle.setIcon(icon21)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icons/ellipse.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_DrawEllipse.setIcon(icon22)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icons/show-interface-names.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_ShowinterfaceNames.setIcon(icon23)
        self.action_ShowinterfaceNames.setObjectName("action_ShowinterfaceNames")
        self.action_Snapshot = QtGui.QAction(MainWindow)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icons/snapshot.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Snapshot.setIcon(icon24)
        self.action_Snapshot.setObjectName("action_Snapshot")
        self.action_EditProject = QtGui.QAction(MainWindow)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icons/edit-project.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_EditProject.setIcon(icon25)
