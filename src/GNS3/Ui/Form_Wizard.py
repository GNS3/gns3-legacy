...
class Ui_Wizard(object):
    def setupUi(self, Wizard):
        ...
        Wizard.resize(QtCore.QSize(QtCore.QRect(0,0,548,333).size()).expandedTo(Wizard.minimumSizeHint()))
        Wizard.setWindowIcon(QtGui.QIcon(":/images/logo_icon.png"))
        ...
        self.pushButton_Step1.setIcon(QtGui.QIcon(":/icons/step1.svg"))
        ...
        self.pushButton_Step2.setIcon(QtGui.QIcon(":/icons/step2.svg"))
